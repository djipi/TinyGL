...
// size: The number of coordinates per array element. The value of size must be 1, 2, 3, or 4.
// type: The data type of each texture coordinate in the array using the following symbolic constants: GL_SHORT, GL_INT, GL_FLOAT, and GL_DOUBLE.
// stride: The byte offset between consecutive array elements. When stride is zero, the array elements are tightly packed in the array.
// pointer: A pointer to the first coordinate of the first element in the array.
#if 0
