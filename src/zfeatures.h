...
/* It is possible to enable/disable (compile time) features in this header file. */
...
/*
 * Matrix of internal and external pixel formats supported. 'Y' means supported.
 * 
 *           External  8    16    24    32
 * Internal 
 *  15                 .     .     .     .
 ...
 * 
 *
 * 15 bpp does not work yet (although it is easy to add it - ask me if you need it).
 * 
 * Internal pixel format: see TGL_FEATURE_RENDER_BITS
 * External pixel format: see TGL_FEATURE_xxx_BITS 
 */

/* enable various convertion code from internal pixel format (usually 16 bits per pixel) to any external format */
#ifndef NO16BITS
