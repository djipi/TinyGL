...
typedef float GLclampf;		/* An IEEE-754 floating-point value, clamped to the range [0,1] */
typedef double		GLdouble;	/* double precision float */
typedef double GLclampd;	/* An IEEE-754 floating-point value, clamped to the range [0,1] */
typedef int GLsizei;
